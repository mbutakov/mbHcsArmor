...
public class ModelArmor2021 implements IModelArmor {
	private int body;
	private int head;
	private int larm;
	private int rarm;
	...
	public ModelArmor2021() {
		if (FMLCommonHandler.instance().getEffectiveSide().isClient()) {
			armor2021 = new ohim("Armor2021.obj",Armor2021.class.getResourceAsStream("/assets/mbhcsarmor/armor/models/Armor2021.obj"));
			this.head = GL11.glGenLists(8);
			GL11.glNewList(this.head, 4864);
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Head");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Body");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Left_right");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Right_arm");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Left_pant");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Right_pant");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Left_leg");
			GL11.glPopMatrix();
			GL11.glEndList();
			...
			GL11.glPushMatrix();
			GL11.glRotatef(90.0F, 0.0F, 1.0F, 0.0F);
			this.armor2021.renderPart("Right_leg");
			GL11.glPopMatrix();
			GL11.glEndList();
	}
	}
