...
public class KrampusArmor{

	
	
	public static ModelKrampus krampus = new ModelKrampus();
	...
	public static class Pants extends ItemArmor {
		...
		public Pants(ArmorMaterial armorMaterial, int par3, int par4) {
			...
			this.setUnlocalizedName("kp");
			this.setTextureName("mbhcsarmor:Krampus_pants");
			this.setNoRepair();
		}
		...
		public static void render(RenderPlayer renderModel){
		      GL11.glPushMatrix();
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedLeftLeg.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.LLEG);
		      GL11.glPopMatrix();
		      GL11.glPushMatrix();
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedRightLeg.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.RLEG);
		      GL11.glPopMatrix();
		}
	}
	...
	public static class Helmet extends ItemArmor{
		public Helmet(ArmorMaterial armorMaterial, int par3, int par4){
			super(armorMaterial, par3, par4);
			this.setCreativeTab(Core.mbHcsArmor);
			this.setUnlocalizedName("kh");
			this.setTextureName("mbhcsarmor:Krampus_head");
			this.setNoRepair();
		}
		...
		public static void render(RenderPlayer renderModel){
			...
			krampus.renderPart(ModelPartRender.MODELPART.HEAD);
			GL11.glPopMatrix();
		}
	}
	...
	public static class Boots extends ItemArmor{
		...
		public Boots(ArmorMaterial armorMaterial, int par3, int par4){
			super(armorMaterial, par3, par4);
			this.setCreativeTab(Core.mbHcsArmor);
			this.setUnlocalizedName("kb");
			this.setTextureName("mbhcsarmor:Krampus_boots");
			this.setNoRepair();
		}
		...
		public static void render(RenderPlayer renderModel){
		      ...
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedLeftLeg.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.LBOOT);
		      GL11.glPopMatrix();
		      GL11.glPushMatrix();
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedRightLeg.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.RBOOT);
		      GL11.glPopMatrix();
			}
	}
	...
	public static class Body extends ItemArmor {
		...
		public Body(ArmorMaterial armorMaterial, int par3, int par4){
			super(armorMaterial, par3, par4);
			this.setCreativeTab(Core.mbHcsArmor);
			this.setUnlocalizedName("kc");
			this.setTextureName("mbhcsarmor:Krampus_body");
			this.setNoRepair();
		}
		...
		public static void render(RenderPlayer renderModel){
		      ...
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.BODY);
		      GL11.glPopMatrix();
		      GL11.glPushMatrix();
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedRightArm.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.RARM);
		      GL11.glPopMatrix();
		      GL11.glPushMatrix();
		      Minecraft.getMinecraft().renderEngine.bindTexture(mbResourceLocation.KRAMPUS);
		      renderModel.modelBipedMain.bipedLeftArm.postRender(0.0625F);
		      KrampusArmor.krampus.renderPart(ModelPartRender.MODELPART.LARM);
		      GL11.glPopMatrix();
			}
	}
